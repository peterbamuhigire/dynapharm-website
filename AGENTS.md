# AGENTS.md — Static Website Project
...
photo-bank/
  ...
  misc/            -> Other images
.Codex/skills/    -> Build instructions (git submodule) — you follow these
...
You have skills in `.Codex/skills/`. Read them before generating any code.
