...
**Prerequisites:** Node.js and the `Codex` CLI (`npm install -g @anthropic-ai/Codex`) with a Pro/Max subscription. Restart Codex after installing plugins.
...
Follow `.Codex/skills/design-system/SKILL.md` to establish:
...
Follow `.Codex/skills/photo-manager/SKILL.md` to:
...
Follow `.Codex/skills/page-builder/SKILL.md` to:
...
Follow `.Codex/skills/seo/SKILL.md` to:
