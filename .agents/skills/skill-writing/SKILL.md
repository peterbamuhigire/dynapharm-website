...
#### SKILL.md Generation Guidelines (Codex)

Use the following prompt when you want Codex to generate a complete, production-ready SKILL.md from your feature/pattern/module details.
...
[When should Codex use this skill? What triggers would indicate this skill is needed?]
...
##### What You Require from Codex

Generate a SKILL.md file that:

1. **YAML Frontmatter** (required):
   - `name`: Concise, lowercase, hyphen-separated skill name
   - `description`: Clear, specific description that tells Codex when to use this skill. Include:
     - What the skill does
...
3. **Content Quality**:
   - Assume Codex is smart; do not over-explain basic concepts
...
4. **File References** (if applicable):
   - If SKILL.md references `scripts/`, `references/`, or `assets/`, explicitly state:
     ...
     - When Codex should use/read that file
